...
Инженер по автоматизации информационной безопасности, Санкт-Петербург. Пишу
инструменты на Python и PowerShell, которые решают реальные задачи команд ИБ:
аудит прав доступа, синхронизация учётных данных между системами, выгрузка
журналов аутентификации с сетевого оборудования.
